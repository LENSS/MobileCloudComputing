 ...
 ******************************************************************************/
package edu.nps.secureshare.shamir;
...
import edu.nps.secureshare.shamir.math.BigIntStringChecksum;
import edu.nps.secureshare.shamir.math.CombinationGenerator;
import edu.nps.secureshare.shamir.math.EasyLinearEquation;
import edu.nps.secureshare.shamir.math.PolyEquationImpl;
...
public class ShamirSecret
{
    ...
    // constructors
    // ==================================================
    public ShamirSecret(final PublicInfo inPublicInfo)
    {
     ...
     *
     */
    public static class PublicInfo implements Serializable
    {
        /**
		 * 
		 */
		private static final long serialVersionUID = -1830128228888666792L;
    ...
    public static class ShareInfo implements Serializable
    {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7168438971234675154L;
		// Identity fields:
...
//        outputEvery = 1;
        int count = -1;
        for (List<ShamirSecret.ShareInfo> usetheseshares : combo)
        {
            count++;
            if (maximumCombinationsToTest != null)
            {
...
//                count = 0;
            ...
            ShamirSecret.CombineOutput solved = this.combine(usetheseshares);
